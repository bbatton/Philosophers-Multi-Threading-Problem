...
The goal is to prevent dead locks where all the philosophers pick up their left or inversly their right fork and become stuck. Also to prevent starvation were some of the philosophers are not able to eat since the other philosophers are hoarding the forks.
